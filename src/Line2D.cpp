...
Line2D::~Line2D(void) noexcept {}

float Line2D::get_endpoint_0_x(void) const noexcept {
    return endpoint_0->get_x_pos();
}

float Line2D::get_endpoint_0_y(void) const noexcept {
    return endpoint_0->get_y_pos();
}

float Line2D::get_endpoint_1_x(void) const noexcept {
    return endpoint_1->get_x_pos();
}

float Line2D::get_endpoint_1_y(void) const noexcept {
